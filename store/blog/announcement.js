...
export const actions = {
    ...
    async create({ commit }, params) {
        try {
            return await Service.post('/blog/announcement/create', params);
        } catch (err) {
            return { err }
        }
    },
    ...
    async lists({ commit }, params = { per_page: 1000 }) {
        ...
        try {
            let res = await Service.get('/blog/announcement/lists', { params })
    ...
    async del({ commit }, params) {
        try {
            return await Service.post('/blog/announcement/del', params);
        } catch (err) {
            return { err }
        }
    },
    ...
    async edit({ commit }, params) {
        try {
            return await Service.post('/blog/announcement/edit', params);
        } catch (err) {
            return { err }
        }
    }
